                    ...
                    {options.map((option) => (
                        ...
                        >
                            ...
                            {option.external ? (
                                ...
                                <Link
                                    to={option.href}
                                    className="mt-6 inline-flex items-center justify-center gap-2 rounded-full border border-copa-gold-500 px-6 py-3 text-sm font-semibold text-copa-gold-700 transition-colors hover:bg-copa-gold-50"
                                >
                                    {option.cta}
